new Vue({
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            rolUsuarioActual.value = localStorage.getItem("rol");
            console.log("ROL:", rolUsuarioActual.value);
        });
 ...
 // Guardar todo el objeto del equipo
        ...
        return {
            ...
            snackbarColor,
            snackbarIcon,
            mostrarAlerta, rolUsuarioActual, mostrarFormulario
        };
    }
});